...
class _LevelDetailPageState extends State<LevelDetailPage> {
  ...
  void initState() {
    super.initState();
    futureCategories = ApiService.getTopicsByLevel(widget.levelIndex);
  }
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            bool isUnlocked =
                                category.level <= 1; // Unlock level 1 and below
  ...
  Widget _buildTaskDialog(BuildContext context, Category category) {
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '${category.name}: Building Resilience',
              style: TextStyle(
                color: Colors.white,
                fontSize: 22,
                fontWeight: FontWeight.bold,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('${category.progress.toStringAsFixed(0)}%',
                      style: TextStyle(
                          color: Colors.white, fontWeight: FontWeight.bold)),
                  SizedBox(width: 8),
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: category.progress == 100
                          ? Colors.green
                          : Colors.transparent,
                    ),
                    child: category.progress == 100
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Text(
                      'Hi! I\'m Nadir, your guide. Watch this video to learn about building ${category.name.toLowerCase()} habits!',
