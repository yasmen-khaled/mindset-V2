...
class AcademicHomePage extends StatefulWidget {
  ...
  const AcademicHomePage({super.key, this.username = 'User'});

  @override
  State<AcademicHomePage> createState() => _AcademicHomePageState();
}
                          ...
                          return GestureDetector(
                            onTap: () async {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => LevelTopicsPage(level: index + 1),
                                ),
                              );
                            },
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  Positioned(
                                    ...
                                    child: Opacity(
                                      opacity: 0.12,
                                      child: Icon(Icons.class_, size: 120, color: Colors.blue[200]),
                                    ),
                                  ),
                                  Padding(
