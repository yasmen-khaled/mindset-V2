              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color.fromARGB(12, 33, 149, 243).withOpacity(0.08 * opacity),
                        blurRadius: 80,
                        spreadRadius: 40,
                      ),
                    ],
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color.fromARGB(36, 33, 149, 243).withOpacity(0.12 * opacity),
                        blurRadius: 60,
                        spreadRadius: 30,
                      ),
                    ],
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color.fromARGB(38, 33, 149, 243).withOpacity(0.15 * opacity),
                        blurRadius: 50,
                        spreadRadius: 25,
                      ),
                    ],
                ...
                if (!isUnlocked) Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 33, 149, 243).withOpacity(0.2),
                      shape: BoxShape.circle,
                      border: Border.all(
                        color: const Color.fromARGB(255, 33, 149, 243).withOpacity(0.4),
                        width: 2.5,
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: const Color.fromARGB(255, 33, 149, 243).withOpacity(0.3),
                          blurRadius: 15,
                          spreadRadius: 6,
                        ),
                      ],
...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  final List<TeamMember> teamMembers = [
    TeamMember(
      ...
      description: 'A passionate developer with a keen eye for design and user experience. Specializes in creating beautiful and performant Flutter applications.',
    ),
    TeamMember(
      name: 'Muhanad',
      ...
      description: 'Expert in building robust backend systems and optimizing server performance. Masters complex architectural challenges with elegant solutions.',
    ),
    TeamMember(
      name: 'Ajwad',
      ...
      description: 'Skilled mobile developer with expertise in API integration and state management. Creates seamless user experiences across platforms.',
    ),
    TeamMember(
      name: 'Nada',
      ...
      description: 'Creative designer who combines aesthetics with functionality. Expert in user research and creating intuitive interfaces that users love.',
    ),
    TeamMember(
      name: 'Yasmena',
      ...
      description: 'Frontend specialist with a passion for creating smooth animations and responsive designs. Brings websites to life with dynamic interactions.',
    ),
    TeamMember(
      name: 'Lujaina',
      ...
      description: 'Strategic product manager who bridges user needs with business goals. Expert in creating roadmaps and delivering successful products.',
    ),
    TeamMember(
      name: 'Maram',
      ...
      description: 'Detail-oriented QA engineer ensuring the highest quality standards. Specializes in automated testing and bug prevention.',
    ),
    TeamMember(
      name: 'Hiba',
      ...
      description: 'DevOps expert managing cloud infrastructure and deployment pipelines. Ensures smooth operation and scalability of systems.',
    ),
  ];
  ...
  Widget _buildFixedButton(double left, double top, int buttonNumber, {Color color = Colors.blue}) {
  ...
  void _showProfileSettings(BuildContext context) {
    final user = _leaderboardUsers[0];
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: coverColors.asMap().entries.map((entry) {
                                                          ...
                                                          TextButton(
                                                            onPressed: () async {
                                                              if (nameController.text.trim().isNotEmpty) {
                                                                ...
                                                                _showProfileSettings(context); // Reopen settings dialog
                                      ...
                                      Expanded(
                                        child: GridView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            final isSelected = selectedSkinIndex == index;
                                            
                                            return GestureDetector(
                                              onTap: () => _handleSkinSelection(context, skin, index),
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  color: Colors.white.withOpacity(0.1),
                                                  borderRadius: BorderRadius.circular(15),
  ...
  void _showGitHubSettings(BuildContext context) {
    ...
    // Load existing GitHub URL if available
