...
void debugSvgContent(String url) async {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('Assets/background/tasks.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
 ...
 {   
  ...
  'http://72.61.101.230:8000/storage/task-avatars/MIqqKGlhOVdUeMGs69d9LY0X0x4b6DZT2RKWRKBg.svg',
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            ClipRRect(
              borderRadius: BorderRadius.circular(14),
              child: Image.network(
                'http://72.61.101.230:8000/storage/${task.image!}',
