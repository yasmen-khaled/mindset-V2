...
class StorageService {
  ...
  static const String _repoUrlKey = 'repo_url';
  ...
  static Future<String?> getGender() async {
    ...
    // Save GitHub repo URL for code tasks
  static Future<void> saveRepoUrl(String repoUrl) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(_repoUrlKey, repoUrl);
  }

  // Get GitHub repo URL
  static Future<String?> getRepoUrl() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_repoUrlKey);
  }
